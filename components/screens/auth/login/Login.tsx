...
export default function Login() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] w-full items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 sm:p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white dark:bg-zinc-900/40 rounded-3xl border border-zinc-200/80 dark:border-zinc-800/80 shadow-2xl p-4 sm:p-8 backdrop-blur-md relative">
        
        {/* Left Side: Premium SaaS branding & features visualizer */}
        <div className="hidden md:flex flex-col space-y-6 p-6 h-full justify-between border-r border-zinc-200 dark:border-zinc-800/60 pr-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Supercharge your doctor registry parsing, location proximity audits, and dataset validation in one clean interface.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">GPS Proximity Auditing</h4>
                <p className="text-[10px] text-muted-foreground">Perform latitude/longitude radial lookups dynamically.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Dynamic Multi-Select Filtering</h4>
                <p className="text-[10px] text-muted-foreground">Instantly filter specialties, medical systems, and locations.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Google Workspace Sync</h4>
                <p className="text-[10px] text-muted-foreground">Access your shared spreadsheets securely with single sign-on.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 text-[10px] text-muted-foreground bg-zinc-50 dark:bg-zinc-900/60 p-2.5 rounded-lg border border-zinc-150 dark:border-zinc-800/80">
            ...
            <span>Verify practitioners with real-time state medical council lookups.</span>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-6 py-6 px-2">
          ...
          <div className="flex flex-col space-y-2 text-center md:text-left">
            ...
            <p className="text-xs text-muted-foreground">
              Authorize using your enterprise Google profile to log in.
            </p>
          </div>

          {!connecting ? (
            /* Main Login Card with Google Button */
            <Card className="border border-zinc-200 dark:border-zinc-800 shadow-md bg-white dark:bg-zinc-900/40 relative">
              <CardHeader className="space-y-1">
                <CardTitle className="text-lg font-bold">Single Sign-On</CardTitle>
                <CardDescription className="text-xs">
                  We use Google OAuth for secure, credential-free authorization.
                </CardDescription>
              </CardHeader>
          ...
          {/* Direct Link to Login (not signup since that's replaced too) */}
